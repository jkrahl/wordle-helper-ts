...
console.log(argv);
var wordLength = parseInt(argv["length"] || "");
...
const file = fs_1.default.readFileSync(path_1.default.join(__dirname, "palabras.txt"), "utf8");
